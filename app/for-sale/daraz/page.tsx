...
export default function DarazPage() {
  ...
  return (
    <PageShell>
      <PageHeader
        eyebrow="For Sale"
        title="Daraz Recommendations"
        description="Recommended study materials, books, and accessories available on Daraz Pakistan. These are affiliate-style suggestions, not products sold directly by Skills and Study."
        breadcrumbs={[
          { label: 'Home', href: '/' },
